 ...
 *******************************************************************************/
package com.ggec.template.web.task;
...
import com.ggec.template.utils.web.Servlets;
...
public class TaskController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		JdbcPage<Task> tasks = taskService.getUserTask(userId, searchParams, pageNumber, pageSize, sortType);
	...
	public String create(Task newTask, RedirectAttributes redirectAttributes) {
